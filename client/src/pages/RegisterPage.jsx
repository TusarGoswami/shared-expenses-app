    ...
    <div className="min-h-screen flex items-center justify-center bg-nebula-bg text-nebula-text px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-nebula-muted mt-2">Join SplitLedger to start splitting expenses</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-nebula-subtle" />
                <input
                  id="reg-name"
                  type="text"
                  value={name}
